      ...
      <div className="row">
        ...
        <div className="col-lg-8 p-0">
          <div className={styles.container}>
            ...
            <h3 className={styles.heading}>Enter Your Team PIN</h3>
            ...
            <div className={styles.keypad}>
              ...
              <button className={styles.iconKey} onClick={handleDelete}>
                <ImCross />
              </button>

              <button className={styles.key} onClick={() => handleInput("0")}>
                0
              </button>

              <button className={styles.iconKey} onClick={handleSubmit}>
                <FaArrowRightLong />
              </button>
            </div>
          </div>
